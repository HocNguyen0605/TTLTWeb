                ...
                <div class="row mt-3">
                    <div class="col-md-auto border-end border-light-subtle d-flex flex-column mb-4 mb-md-0 pe-md-4">
                        ...
                        <div class="nav flex-column nav-tabs border-0 gap-2" id="profileTab" role="tablist"
                            ...
                            <button class="nav-link text-decoration-none text-start rounded text-wrap ${activeTab != 'password' ? 'active' : ''}"
                                    id="info-tab"
                            ...
                            <a href="${pageContext.request.contextPath}/logout"
                               ...
                               class="nav-link text-decoration-none text-start text-danger text-wrap mt-3 fw-bold bold-0">
                    ...
                    <div class="col-md ps-md-4">
                        <div class="tab-content" id="profileTabContent">
                            <div class="tab-pane fade ${activeTab != 'password' ? 'show active' : ''}" id="info-pane"
                                 role="tabpanel">
                                <h5 class="fw-bold mb-4">Thông tin cá nhân</h5>
                                <jsp:include page="/view/user/profileContents/info.jsp"/>
                            </div>
                            ...
                            <div class="tab-pane fade ${activeTab == 'password' ? 'show active' : ''}"
                                ...
                                <jsp:include page="/view/user/profileContents/changepass.jsp"/>
                            </div>
                        </div>
                    </div>
                </div>
